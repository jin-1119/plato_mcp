"""Tools: list_notices, get_notice_detail (issue #22).

list_qna / get_qna_detail land here too, in issue #23.
"""
...
from plato_mcp.ubboard.scraper import get_notice_detail_for, list_notices_for
